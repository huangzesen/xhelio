...
class SpiceMCPClient:
    ...
    async def _async_connect(self):
        ...
        # Use the heliospice-mcp CLI entrypoint from the heliospice package.
        # Fall back to `python -m heliospice.server` if the CLI isn't on PATH.
        heliospice_mcp = shutil.which("heliospice-mcp")
        if heliospice_mcp:
            command = heliospice_mcp
            args = []
        else:
