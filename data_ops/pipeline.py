    ...
    def execute_stale(
        ...
        for i, node_id in enumerate(stale_ids):
            ...
            try:
                ...
                elif node.tool in ("generate_mpl_script", "generate_jsx_component"):
                    # MPL/JSX renders are terminal — no replay handler yet,
                    # but they participate in pipeline tracking.
                    pass
                else:
    ...
    def to_summary(self) -> dict:
        ...
        for nid in self.topological_order():
            ...
            if node.tool == "fetch_data":
                ...
                summary["render_type"] = "mpl" if node.tool == "generate_mpl_script" else "jsx"
    ...
    def from_session(
        ...
        for i, rec in enumerate(filtered):
            ...
            if tool == "fetch_data":
                ...
                clean_args = {k: v for k, v in args.items() if k != "already_loaded"}
                step_description = "Render matplotlib plot"

            elif tool == "generate_jsx_component":
                clean_args = {k: v for k, v in args.items() if k != "already_loaded"}
                step_description = "Render JSX component"
        ...
        for i, step in enumerate(sorted_steps):
            ...
            try:
                ...
                if tool == "fetch_data":
                    ...
                    if fig is not None:
                        result.figure = fig
                elif tool in ("generate_mpl_script", "generate_jsx_component"):
                    # MPL/JSX renders are terminal — no replay handler yet,
                    # but they participate in pipeline tracking.
                    pass
                else:
