...
from data_ops.custom_ops import CATALOGED_SUBMODULES

# Packages and submodules to catalog — derived from sandbox_registry.json
_CATALOGED_PACKAGES = CATALOGED_SUBMODULES
