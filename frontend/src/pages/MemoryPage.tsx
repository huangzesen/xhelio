...
export function MemoryPage() {
  ...
  const [activeTab, setActiveTab] = useState<'memories' | 'validation'>('memories');
  const {
    memories,
    globalEnabled,
    loading,
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-4">
          <h1 className="text-xl font-semibold text-text">
            {activeTab === 'memories' ? 'Agent Memory' : 'Data Validation'}
          </h1>
              ...
              <>
                ...
                {!loading && memories.length > 0 && (
                  <>
                    {/* Stats bar */}
                    {stats && (
                      <MemoryStatsBar stats={stats} totalMemories={memoryCount} memories={memories} />
                    )}
