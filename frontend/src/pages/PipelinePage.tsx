...
import { StepTable } from '../components/pipeline/StepTable';
import { CodeViewer } from '../components/pipeline/CodeViewer';
import { Loader2, Play, RefreshCw, GitBranch, Inbox, ExternalLink, Save, Check, X, ChevronRight } from 'lucide-react';
import { PipelineSkeleton } from '../components/common/Skeleton';
  ...
  return (
    <div className="flex-1 overflow-hidden flex">
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden p-4 space-y-4 bg-surface">
        ...
        {replayResult?.figure && (
          <div className="bg-panel rounded-xl border border-border p-4 overflow-hidden">
            <h3 className="text-sm font-medium text-text mb-2">Replayed Figure</h3>
